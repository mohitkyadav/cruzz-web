            ...
            <ul className="uk-navbar-nav">
              {
                ...
                <li><Link className="ov-color-white ov-nav-link" to="/profile" uk-icon="icon: user; ratio: 1.2" uk-tooltip={ `title: ${this.props.auth.user.first_name}; pos: bottom-center `}></Link></li>
                ):
                null
              }
              {
